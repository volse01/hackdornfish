...
# Configuration
css_file = os.path.expanduser('~/Nextcloud/Documents/hackdornfish/hackdornfish_dark.css')  # Path to the CSS file
output_file = os.path.expanduser('~/Nextcloud/Documents/hackdornfish/boxes.png')  # Output PNG file
